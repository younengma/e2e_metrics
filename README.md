E2E NLG Challenge Evaluation metrics (py3)
====================================

**This repository is adappted from:**
[DigitalPhonetics/nlg-eval/e2e_metrics](https://github.com/DigitalPhonetics/nlg-eval/tree/master/e2e-metrics) （which runs on python 2.7)
**I make some changes to enable it to run on python 3。**
...
- Java 1.8
- Python 3.6 and above with [matplotlib](https://pypi.python.org/pypi/matplotlib) and [scikit-image](https://pypi.python.org/pypi/scikit-image) packages
